...
template <sclMath::c_Scalar T_SCALAR, sclMath::c_FullMatrix T_MATRIX>
sclMath::c_FullMatrix auto operator*(const T_SCALAR s, const T_MATRIX &m) {
...
template <sclMath::c_FullMatrix T_SCALAR, sclMath::c_FullMatrix T_MATRIX>

sclMath::c_FullMatrix auto operator*(const T_MATRIX &m, const T_SCALAR s) {
  return s * m;
}
